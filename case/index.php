            ...
            <div id="waterfall" class="container-fluid row">
              <!-- <div class="col-xs-12 col-sm-4 column"> -->
                <?php
                  ...
                  if($cnt_case) {
                    for($i = 0; $i < $cnt_case; $i++) {
                      echo '<div class="col-xs-12 col-sm-4 column">';
                      echo '<a href="'. $result_case[$i]["st_path"] .'" class="item">';
                      echo '<div class="hd-pic"><img src="'. json_decode($result_case[$i]["ct_image"], TRUE)[0]["url"] .'" alt=""></div>';
                      echo '<div class="bd-txt">';
                      echo '<span class="title">'. $result_case[$i]["ct_title"] .'</span>';
                      echo '<span class="glyphicon glyphicon-menu-right"></span></div></a></div>';
                    }
                  }
                  else {
            ...
            <div id="waterfall" class="container-fluid row">
              <!-- <div class="col-xs-12 col-sm-4 column"> -->
                <?php
                  ...
                  if($cnt_case1) {
                    for($i = 0; $i < $cnt_case1; $i++) {
                      echo '<div class="col-xs-12 col-sm-4 column">';
                      echo '<a href="'. $result_case1[$i]["st_path"] .'" class="item">';
                      echo '<div class="hd-pic"><img src="'. json_decode($result_case1[$i]["ct_image"], TRUE)[0]["url"] .'" alt=""></div>';
                      echo '<div class="bd-txt">';
                      echo '<span class="title">'. $result_case1[$i]["ct_title"] .'</span>';
                      echo '<span class="glyphicon glyphicon-menu-right"></span></div></a></div>';
                    }
                  }
                  else {
            ...
            <div id="waterfall" class="container-fluid row">
              <!-- <div class="col-xs-12 col-sm-4 column"> -->
                <?php
                  ...
                  if($cnt_case2) {
                    for($i = 0; $i < $cnt_case2; $i++) {
                      echo '<div class="col-xs-12 col-sm-4 column">';
                      echo '<a href="'. $result_case2[$i]["st_path"] .'" class="item">';
                      echo '<div class="hd-pic"><img src="'. json_decode($result_case2[$i]["ct_image"], TRUE)[0]["url"] .'" alt=""></div>';
                      echo '<div class="bd-txt">';
                      echo '<span class="title">'. $result_case2[$i]["ct_title"] .'</span>';
                      echo '<span class="glyphicon glyphicon-menu-right"></span></div></a></div>';
                    }
                  }
                  else {
            ...
            <div id="waterfall" class="container-fluid row">
              <!-- <div class="col-xs-12 col-sm-4 column"> -->
                <?php
                  ...
                  if($cnt_case3) {
                    for($i = 0; $i < $cnt_case3; $i++) {
                      echo '<div class="col-xs-12 col-sm-4 column">';
                      echo '<a href="'. $result_case3[$i]["st_path"] .'" class="item">';
                      echo '<div class="hd-pic"><img src="'. json_decode($result_case3[$i]["ct_image"], TRUE)[0]["url"] .'" alt=""></div>';
                      echo '<div class="bd-txt">';
                      echo '<span class="title">'. $result_case3[$i]["ct_title"] .'</span>';
                      echo '<span class="glyphicon glyphicon-menu-right"></span></div></a></div>';
                    }
                  }
                  else {
            ...
            <div id="waterfall" class="container-fluid row">
              <!-- <div class="col-xs-12 col-sm-4 column"> -->
                <?php
                  ...
                  if($cnt_case4) {
                    for($i = 0; $i < $cnt_case4; $i++) {
                      echo '<div class="col-xs-12 col-sm-4 column">';
                      echo '<a href="'. $result_case4[$i]["st_path"] .'" class="item">';
                      echo '<div class="hd-pic"><img src="'. json_decode($result_case4[$i]["ct_image"], TRUE)[0]["url"] .'" alt=""></div>';
                      echo '<div class="bd-txt">';
                      echo '<span class="title">'. $result_case4[$i]["ct_title"] .'</span>';
                      echo '<span class="glyphicon glyphicon-menu-right"></span></div></a></div>';
                    }
                  }
                  else {
